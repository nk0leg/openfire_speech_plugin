<%@ page import="java.util.*,
				...
				org.jivesoftware.openfire.plugin.UserTranslaterPlugin,
...
<%
	...
	UserTranslaterPlugin plugin = (UserTranslaterPlugin) XMPPServer.getInstance().getPluginManager().getPlugin("contentfilter");
