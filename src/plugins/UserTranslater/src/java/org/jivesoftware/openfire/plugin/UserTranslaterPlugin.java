 ...
 * @author Conor Hayes
 */
public class UserTranslaterPlugin implements Plugin, PacketInterceptor {

	private static final Logger Log = LoggerFactory.getLogger(UserTranslaterPlugin.class);
